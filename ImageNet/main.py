"""
Lord-ViT training and evaluating script
This script is modified from t2t-vit (https://github.com/yitu-opensource/T2T-ViT) and pytorch-image-models by Ross Wightman (https://github.com/rwightman/pytorch-image-models/)
...
parser = argparse.ArgumentParser(description='AMM-T2T-ViT Training and Evaluating')

# Dataset / Model parameters
parser.add_argument('data', metavar='DIR',
                    help='path to dataset')
parser.add_argument('--model', default='Lord_vit_39', type=str, metavar='MODEL',
